...
$context = ['data' => $data, 'timestamp' => new DateTime(), 'userName'=>$userName, 'message'=>$message ];
$text = $twig->render('email.txt.twig', $context);
$html = $twig->render('confirm.html.twig', $context);
...
$message->setFrom('JWS@gojws.com', 'JWS Website Form')
        ...
        ->setSubject('JWS Confirmation Email')
