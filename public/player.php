...
$html = $twig->render('playeremail.html.twig', $context);

// Create an email message.
$message = new Swift_Message();
$message->setFrom('JWS@gojws.com', 'JWS Website')
        ->setTo('scott@gojws.com', 'Scott Mann')
        ->addTo('dennis@gojws.com', 'Dennis Dick')
        ->addBcc('tjmaco@gmail.com', 'TJ Maco')
        ->setSubject('New Player Registration')
